...
public class GoogleOAuthConfig {
    ...
    private static final String[] CONF_PROPERTIES_NAMES = { Labels.CLIENT_ID, Labels.CLIENT_SECRET, Labels.SCOPE, Labels.REDIRECT_URI, ACCESS_TOKEN_END_POINT_PROPERTY_NAME, CODE_END_POINT_PROPERTY_NAME, USER_INFO_END_POINT_PROPERTY_NAME };
