...
public class GoogleOAuth {
    ...
    public static GoogleOAuthTokens askForOAuthTokens(String code) throws IOException {
        ...
        if (tokensResponse.getStatus() == 200) {
            ...
            throw new IOException(String.format("Error during Tokens Request :" + "\n Response Status : %s " + "\n Response Text : %s", tokensResponse.getStatus(), tokensResponse.getString()));
        }
    }
    ...
    public static GoogleUserInfo askForUserInfo(GoogleOAuthTokens googleOAuthTokens) throws IOException {
        ...
        if (userInfoResponse.getStatus() == 200) {
            ...
            throw new IOException(String.format("Error during User Info Request :" + "\n Response Status : %s " + "\n Response Text : %s", userInfoResponse.getStatus(), userInfoResponse.getString()));
        }
    }
